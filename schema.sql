/*
* ConsulClick Database
* @author Abraham Mousalli & Miguel Gil
*/
create database consulclick;
use consulclick; 
set sql_mode='';
create table user (
...
insert into user (username,password,is_admin,is_active,created_at) value ("user",sha1(md5("user")),0,1,NOW());
